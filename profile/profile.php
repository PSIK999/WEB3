...
$query = $conn->prepare("SELECT first_name, last_name, email FROM users WHERE email=?");
...
<head>
  ...
  <link rel="stylesheet" href="profile.css" /> <!-- Your custom CSS file -->
</head>
...
<body>
        ...
        <div class="row no-gutters row-bordered row-border-light">
          <div class="col-md-3 pt-0">
            <div class="list-group list-group-flush account-settings-links">
              ...
              <a class="list-group-item list-group-item-action" data-toggle="list" href="#Orders-history">Orders
                history</a>
              <a class="list-group-item list-group-item-action" data-toggle="list"
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <input type="text" name="first_name" class="form-control" placeholder=""
                          value="<?php echo isset($new_first_name) ? $new_first_name : ''; ?>">
                      </div>
                      <div class="col-md-6">
                        <label class="form-label">Last Name</label>
                        <input type="text" name="last_name" class="form-control" placeholder=""
                          value="<?php echo isset($new_last_name) ? $new_last_name : ''; ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="form-label">E-mail</label>
                      <input type="text" name="email" class="form-control mb-1" placeholder=""
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST["submit"]) && $_POST["submit"] == "Save") {
          ...
          if (!empty($new_first_name) || !empty($new_last_name)) {
            ...
            $email = $_SESSION['email']; // Retrieve user's email from session (assuming it's already set)
            $stmt = $conn->prepare("UPDATE users SET first_name=?, last_name=? WHERE email=?");
            $stmt->bind_param("sss", $new_first_name, $new_last_name, $email);
            $stmt->execute();
            $stmt->close();
          }

          // Display updated email even if it's not changed
          $email = $_SESSION['email'];
 ...
 Mount lebanon , sahel alma , next to jamil market.</textarea>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" placeholder="next to jamil market" />
        </div>
        <div class="form-group">
      ...
      <div class="card-body pb-2">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" value="+961 81 381 666" />
        </div>
      </div>
    </div>
      ...
      <div class="card-body pb-2">
        ...
        <div class="form-group">
          <label class="switcher">
            ...
            <span class="switcher-label">Email me when special products drops.</span>
          </label>
        </div>
        <div class="form-group">
          <label class="switcher">
